...
function displayCardsDynamically(collection) {
    ...
    function updateBookmark(hikeID) {
        currentUser.get().then((userDoc) => {
            ...
            iconID = 'save-' + hikeID;
            let isBookmarked = bookmarks.includes(hikeID); // check if this hikeID exists in the bookmark array
            ...
            if (isBookmarked) {
                ...
                currentUser.update({
                    ...
                    console.log("this item is added to the database" + isBookmarked)
